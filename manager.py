...
class Match:
    ...
    def run_match(self, binary):
        command = self.get_command(binary)
        print(command)
...
class Commandline:
    ...
    def act(self):
        ...
        self.manager = Manager(game_command, self.cmds.db_filename)
